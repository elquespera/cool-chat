...
export function ContactSearchInput() {
  ...
  return (
    <div className="px-4 py-3">
      ...
      <div className="group mb-4 flex items-center gap-2 rounded-3xl bg-accent px-2 py-1 text-accent-foreground transition-colors focus-within:bg-primary/10 dark:focus-within:bg-primary/30">
